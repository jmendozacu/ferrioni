                    ...
                    storage.post(
                        ...
                        function (response) {
                            ...
                            if(obj_response.status == 0){
                                ...
                                if(coupon){
                                    $('.popup-step-2 .popup-content').prepend(function () {
                                        return '<div class="popup-coupon"><span> Tu código de descuento es <span class="coupon"> ' + coupon + '</span></span></div>';
                                    });
                                }
                                if(thankyou){
                                    ...
                                    $('.popup-step-2 .popup-content').append(function () {
                                        return '<div class="popup-thankyou"><span>Gracias</span></div>';
                                    });
                                }
                            }
                        }
