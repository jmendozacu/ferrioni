...
(function($) {
    ...
    TC_Instance.prototype.initialize = function(clear_listeners) {
        ...
        this.data.attributes.radius = ((this.data.attributes.item_size * 0.68) - this.data.attributes.line_width) / 2;
        ...
        for (var key in this.data.text_elements) {
            ...
            textElement.css("top", Math.round(0.32 * this.data.attributes.item_size));
